...
import { SocketProvider } from '../../app/hooks/useSockects'; // Path matching your app/hooks/useSockets.tsx setup
            ...
            <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
              <div className="flex items-center gap-8">
                ...
                <nav className="hidden md:flex items-center gap-6">
                  <Link href="/forum" className="text-sm font-medium text-blue-400 hover:text-blue-300 transition">
                    Forum
                  </Link>
