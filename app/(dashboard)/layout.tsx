...
import { MainNav } from '@/components/shared/MainNav'; // Import the client-side navigation component
            ...
            <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
              <div className="flex items-center gap-8">
                ...
                <Link href="/" className="relative w-28 h-8 block">
                  <Image
                    src="/logo.png" // Refers to public/logo.png
                    alt="Rhemaka Logo"
                    fill
                    priority
                ...
                {/* Mount the client-side navigation component */}
                <MainNav isLoggedIn={!!session?.user} />
              </div>
